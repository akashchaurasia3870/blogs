...
function NewsLatter() {
    ...
    return (
        <div className='flex items-center justify-between rounded-lg text-sm md:text-lg lg:text-sm'
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center mb-4 md:mb-0 w-full md:w-[50%] text-center">
                <h2 className="text-2xl md:text-3xl font-semibold ">Stay Updated!</h2>
